    ...
    <div>
        <div class="shopcart">
            ...
            <div class="ball-container">
                <transition name="drop"  v-for="(ball,index) in balls"  v-on:before-enter="beforeEnter" :key="index"
                            v-on:enter="enter"
        ...
        <transition name="fade">
            <div class="list-mask" v-show="listShow" @click="toggleList" @touchmove.prevent ></div>
        </transition>
    </div>
</template>
...
<script>
    ...
    export default {
        ...
        props: {
            ...
            selectFoods: {
                type: Array,//如果是Object或者Array  default必须是一个函数
                default() {
                    return [];
                }
            }
            ...
            listShow() {
                ...
                if(show) {
                    if(!this.CartScroll) {
                        ...
                        console.log(this.CartScroll);
                    }else{
                        this.$nextTick(() => {
                            // this.CartScroll.finishPullUp();//重新计算
                            this.CartScroll.refresh();//重新计算
                            console.log(this.CartScroll);
                        })
                    }
                }
...
<style scoped lang="less">
    ...
    .shopcart {
        ...
        .shopcart-list {
            ...
            width: 100%;
            padding-bottom: 48px;
            transform: translate3d(0,-100%,0);//动画结束后的效果需要在此处进行设置
            .list-header {
                height: 40px;
