        ...
        <div class="food" v-show="showFlag" ref="food">
            <div class="food-content">
                ...
                <div class="content">
                    ...
                    <div class="price">
                        <span>￥<span class="now">{{food.price}}</span></span><span class="old" v-show="food.oldPrice">￥{{food.oldPrice}}</span>
                    </div>
                ...
                <ratingselect :select-type="selectType" :only-content="onlyContent" :desc="desc" :ratings="food.ratings" @select="select" @toggleContent="toggleContent"></ratingselect>
